...
import 'package:elearny/ui/widgets/shared_widget/drawer_widget.dart';
                        ...
                        builder: (data) {
                          return SideMenuData(
                              ...
                              items: [
                                ...
                                sideMenuItemDatatile(context, 3,
                                    "Edit app Links", FontAwesomeIcons.link),
  ...
  SideMenuItemDataTile customSideMenuItemDatatile(
    ...
    return SideMenuItemDataTile(
      ...
      icon: const UnconstrainedBox(
        child: ImageIcon(
          AssetImage(Assets.quizIconDarkMode),
          size: 30,
        ),
      ),
      // selectedIcon: const Icon(Icons.home),
