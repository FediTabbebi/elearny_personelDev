...
import 'package:elearny/core/services/storage/upload_files.dart';
...
class AdminEditSocialLinksProvider with ChangeNotifier {
  ...
  Future<List<AdminLinksModel?>> getData(
    BuildContext context,
  ) async {
